      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            {[1, 2, 3, 4].map(i => (
              <div key={i} className="animate-pulse bg-neutral-50 p-8">
                <div className="mb-6 h-64 bg-neutral-200 md:h-80"></div>
                <div className="mb-3 h-8 w-3/4 rounded bg-neutral-300"></div>
                <div className="mb-4 h-4 w-full rounded bg-neutral-200"></div>
              </div>
            ))}
          </div>
        </div>
